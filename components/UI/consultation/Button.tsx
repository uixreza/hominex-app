...
const Button = ({ title, handleFunc, keyId, isActive }: IButton) => {
  return (
    <div
      ...
      className={` sm:text-[14px] text-[12px] bg-[var(--box)]/60  backdrop:blur-3xl bg-opacity-40 backdrop-blur-md shadow-lg shadow-black/20 w-[40%] flex flex-row items-center sm:justify-between justify-center gap-2 sm:px-4 sm:py-3 px-0 py-2 rounded-xl cursor-pointer ${
